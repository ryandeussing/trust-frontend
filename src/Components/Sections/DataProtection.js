      ...
      cards: [
        {
          ...
          footer: link(
            intl.formatMessage(messages.openShiftDedicatedFooter),
            'https://access.redhat.com/products/openshift-dedicated-red-hat'
          ),
        },
        {
      ...
      cards: [
        {
          ...
          footer: link(
            intl.formatMessage(messages.redhatSsoFooter),
            'https://access.redhat.com/start/how-to-create-and-manage-users'
          ),
        },
        {
          ...
          footer: link(
            intl.formatMessage(messages.roleBasedAccessFooter),
            'https://access.redhat.com/documentation/en-us/red_hat_hybrid_cloud_console/2023/html/user_access_configuration_guide_for_role-based_access_control_rbac/index'
          ),
        },
      ],
    },
      ...
      cards: [
        {
          ...
          footer: link(
            intl.formatMessage(messages.gdprPiiFooter),
            'https://www.redhat.com/en/gdpr'
          ),
        },
        {
          ...
          footer: link(
            intl.formatMessage(messages.dataControlsFooter),
