...
const DataCollection = () => {
    ...
    const protectionData = [{
        ...
        cards: [{
            ...
            footer: link(intl.formatMessage(messages.ipHostnameObfFooter), 'https://access.redhat.com/documentation/en-us/red_hat_insights/2022/html-single/client_configuration_guide_for_red_hat_insights/index#proc-obfuscating-ipv4-address_insights-client-cg')
        }, {
            title: intl.formatMessage(messages.minimalHostImpact),
            body: intl.formatMessage(messages.minimalHostImpactBody),
            footer: link(intl.formatMessage(messages.minimalHostImpactFooter), 'https://access.redhat.com/documentation/en-us/red_hat_insights/2022/html-single/client_configuration_guide_for_red_hat_insights/index#con-insights-changing-the-client-schedule_insights-cg-changing-schedule')
        }, {
            ...
            footer: link(intl.formatMessage(messages.granularControlsFooter), 'https://access.redhat.com/documentation/en-us/red_hat_insights/2022/html-single/client_configuration_guide_for_red_hat_insights/index#con-insights-client-data-redaction_insights-client-cg')
        }, {
            title: intl.formatMessage(messages.payloadTesting),
            body: intl.formatMessage(messages.payloadTestingBody),
            footer: link(intl.formatMessage(messages.payloadTestingFooter), 'https://access.redhat.com/documentation/en-us/red_hat_insights/2022/html-single/client_configuration_guide_for_red_hat_insights/index#proc-validating-remove.conf-file_insights-client-cg')
        }, {
